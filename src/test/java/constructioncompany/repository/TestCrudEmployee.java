...
public class TestCrudEmployee {
    ...
    public void testCreate() throws Exception {
        Manager employee = new Manager.Builder(232).department("Maintenance").jobTitle("Maintenance Manager").name("Jim").numberOfEmployees("56").phoneNumber("3445555").build();
    ...
    public void testUpdate() throws Exception {
        Manager employee = repository.findOne(id);
        Manager newEmployee = new Manager.Builder(43).department("The Department").jobTitle("manager").name("jake").numberOfEmployees("56").phoneNumber("454564").build();
