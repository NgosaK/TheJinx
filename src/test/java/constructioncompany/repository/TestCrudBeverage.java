...
public class TestCrudBeverage {
    ...
    {
        Beverage beverage= new Beverage.Builder(1).category("Soda").volume("500").name("cream soda").price("500").build();
    ...
    public void testUpdate() throws Exception {
        Beverage beverage = repository.findOne(id);
        Beverage newBeverage = new Beverage.Builder(12).category("Soda").volume("500").name("cream soda").price("500").build();
